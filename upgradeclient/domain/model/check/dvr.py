...
class DVR(ABS):
    ...
    def from_json(json_data):
        ...
        if DVR.NAME in all_dict:
            dict_data = all_dict[DVR.NAME]
        else:
            dict_data = all_dict
        ...
        dvr = DVR(base_url=base_url, proxy_host=proxy_host, target_host=target_host, revision_seconds=revision_seconds,
